...
| business_license_number | str | License info section | Mã số doanh nghiệp |
| business_license_date | str/null | License date | YYYY-MM-DD format |
| business_license_place | str | License issue place | - |
...
| activity_field_codes | array[str] | Checked boxes | ["production", "import"] |
...
| organization_name | str | "Tên tổ chức:" section | Must be specific |
| business_license_number | str | License info section | - |
| business_license_date | str/null | License date | YYYY-MM-DD format |
| business_license_place | str | License issue place | - |
| legal_representative_name | str | Representative section | - |
| legal_representative_position | str | Representative section | - |
