...

{
  ...
  "substance_usage": [
    // Table 1.1 data - ALL fields must be included:
    {
      ...
      "substance_name": "<IMPORTANT: If is_title=true, this contains the section title (e.g., 'Sản xuất chất được kiểm soát', 'Nhập khẩu chất được kiểm soát', 'Xuất khẩu chất được kiểm soát'). If is_title=false, this contains the standardized substance name from official list (e.g., 'HFC-134a', 'HCFC-22')>",
  ...
  "collection_recycling": [
    ...
    // IMPORTANT: One PDF row may create 4 records (collection, reuse, recycle, disposal)
    {
      ...
      "substance_name": "<IMPORTANT: If is_title=true, this contains the section title. If is_title=false, this contains the standardized substance name from official list>",
...

{
  ...
  "quota_usage": [
    // Table 2.1 data - ALL fields must be included:
    {
      ...
      "sequence": <integer>,
      "usage_type": "<production|import|export>",
      "substance_name": "<IMPORTANT: If is_title=true, this contains the section title (e.g., 'Sản xuất', 'Nhập khẩu', 'Xuất khẩu'). If is_title=false, this contains the standardized substance name from official list>",
